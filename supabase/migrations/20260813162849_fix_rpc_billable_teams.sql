-- Update get_project_costs to handle weekly capacity correctly with BILLABLE_TEAMS logic
...
-- Update get_project_costs_monthly to handle weekly capacity correctly with BILLABLE_TEAMS logic
...
-- Update get_project_costs_by_role to handle weekly capacity correctly with BILLABLE_TEAMS logic
